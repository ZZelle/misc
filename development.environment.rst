...
But you must avoid to use in nova-scheduler filters limiting the number of instances per compute (like RamFilter, DiskFilter, AggregateCoreFilter),
otherwise you will still be limited by fake constraints !
